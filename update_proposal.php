...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $file_tmp = $_FILES['file_proposal']['tmp_name'];
     if ($file_proposal) {
        ...
        $query = "UPDATE proposal_dosen SET judul = '$judul', file_proposal = '$file_proposal' WHERE id_proposal = $id";
    } else {
        $query = "UPDATE proposal_dosen SET judul = '$judul' WHERE id_proposal = $id";
    }
